...
Route::prefix('lab')->name('lab.')->group(function () {
    ...
    Route::prefix('samples')->name('samples.')->group(function () {
        ...
        // Esta ruta procesa la petición de actualización de una muestra existente
        Route::put('/update_result/{sampleResult}', 'SampleController@update_result')->name('update_result');

        // Esta ruta procesa la petición de actualización de fecha y archivo de una prestación
        Route::put('/update_file/{sample}', 'SampleController@update_file')->name('update_file');
...
Route::prefix('parameters')->as('parameters.')->middleware('auth')->group(function () {
    ...
    // Se crea un prefijo para las rutas de tipos de muestras
    Route::prefix('sample_types')->name('sample_types.')->group(function () {
        // Esta ruta muestra la lista de tipos de muestras
        Route::get('/', 'SampleTypeController@index')->name('index');

        // Esta ruta muestra el formulario para crear un nuevo tipo de muestra
        Route::get('/create', 'SampleTypeController@create')->name('create');

        // Esta ruta procesa la petición de creación de un nuevo tipo de muestra
        Route::post('/store', 'SampleTypeController@store')->name('store');

        // Esta ruta muestra el formulario para editar un tipo de muestra existente
        Route::get('/{sampleType}/edit', 'SampleTypeController@edit')->name('edit');

        // Esta ruta procesa la petición de actualización de un tipo de muestra existente
    ...
    Route::prefix('exam_types')->name('exam_types.')->group(function () {
        ...
        Route::get('/', 'ExamTypeController@index')->name('index');

        // Esta ruta muestra el formulario para crear un nuevo tipo de examen
        Route::get('/create', 'ExamTypeController@create')->name('create');

        // Esta ruta procesa la petición de creación de un nuevo tipo de examen
        Route::post('/store', 'ExamTypeController@store')->name('store');

        // Esta ruta muestra el formulario para editar un tipo de examen existente
        Route::get('/{examType}/edit', 'ExamTypeController@edit')->name('edit');
...
Route::get('/email_queue_test/{cant}', 'SuspectCaseController@emailQueueTest')->middleware('auth');
Route::get('/email_test', 'SuspectCaseController@emailTest')->middleware('auth');
